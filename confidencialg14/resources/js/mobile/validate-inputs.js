document.getElementById('form-create-user').addEventListener('submit', function(event) {
    ...
    document.querySelectorAll('.error-icon').forEach(icon => icon.classList.remove('error-icon-active'));
    ...
    function showError(inputId, errorId, message) {
        ...
        if (errorText && errorIcon) {
            errorIcon.insertAdjacentElement('afterend', errorText);
